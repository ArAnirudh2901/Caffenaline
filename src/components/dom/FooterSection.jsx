    ...
    >
      <div className="w-full max-w-6xl mx-auto px-6 lg:px-16">
        ...
        <div className="footer-reveal mb-12 lg:mb-16">
          <span
            className="font-mono text-xs uppercase tracking-[0.4em] block mb-3"
            style={{ color: '#C89F70' }}
          >
            Find Us
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 mb-16">
          ...
          <TiltGlassCard className="p-8 footer-reveal">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.3em]" style={{ color: '#C89F70' }}>
                Location
              </span>
            </div>
            ...
            <p className="text-sm leading-relaxed" style={{ color: '#766161' }}>
              123 Extreme Ave<br />
              Adrenaline District
            </p>
          </TiltGlassCard>
          ...
          <TiltGlassCard className="p-8 footer-reveal">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm font-mono" style={{ color: '#766161' }}>6:00 AM – 8:00 PM</p>
              </div>
              <div>
                <h4 className="text-sm font-bold uppercase tracking-tight mb-1" style={{ color: '#4A362D' }}>
                  Sat – Sun
                </h4>
                <p className="text-sm font-mono" style={{ color: '#766161' }}>7:00 AM – 9:00 PM</p>
              </div>
            </div>
          </TiltGlassCard>
        ...
        {/* Email CTA */}
        <div className="footer-reveal glass-panel p-8 md:p-12 max-w-2xl mx-auto text-center">
          <h3
          ...
          <p className="text-sm mb-6" style={{ color: '#766161' }}>
        ...
        <div className="footer-reveal mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4" style={{ borderTop: '1px solid rgba(118, 97, 97, 0.1)' }}>
          <span className="font-mono text-[10px] uppercase tracking-[0.3em]" style={{ color: 'rgba(118, 97, 97, 0.4)' }}>
          ...
          <div className="flex gap-6">
            {['Instagram', 'Twitter', 'TikTok'].map((social) => (
              <a
                key={social}
                href="#"
                className="font-mono text-[10px] uppercase tracking-[0.2em] hover:opacity-100 transition-opacity"
